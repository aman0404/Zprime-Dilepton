...
df = df[(df["r"]==f"{parameters['regions']}") & (df["dielectron_mass"] > 200.) & (df["dielectron_mass_gen"] > 200) & (df["nbjets"]==0)]
...
wgt_scale_up = df["dielectron_mass_scaleUncUp"].compute().values
wgt_scale_dn = df["dielectron_mass_scaleUncDown"].compute().values
...
hist2del = TH2F("response_el","response_el", 7, array('d',binsx), 7, array('d',binsx))
#hist2del = TH2F("response_el","response_el",8,array('d',binsx), 8, array('d',binsx))

hist2del_id_up    = TH2F("hist2del_id_up","hist2del_id_up", 7 ,array('d',binsx), 7, array('d',binsx))
hist2del_id_dn    = TH2F("hist2del_id_dn","hist2del_id_dn", 7 ,array('d',binsx), 7, array('d',binsx))
hist2del_l1_up    = TH2F("hist2del_l1_up","hist2del_l1_up", 7 ,array('d',binsx), 7, array('d',binsx))
hist2del_l1_dn    = TH2F("hist2del_l1_dn","hist2del_l1_dn", 7 ,array('d',binsx), 7, array('d',binsx))
hist2del_pu_up    = TH2F("hist2del_pu_up","hist2del_pu_up", 7 ,array('d',binsx), 7, array('d',binsx))
hist2del_pu_dn    = TH2F("hist2del_pu_dn","hist2del_pu_dn", 7 ,array('d',binsx), 7, array('d',binsx))
hist2del_pdf_up   = TH2F("hist2del_pdf_up","hist2del_pdf_up", 7 ,array('d',binsx), 7, array('d',binsx))
hist2del_pdf_dn   = TH2F("hist2del_pdf_dn","hist2del_pdf_dn", 7 ,array('d',binsx), 7, array('d',binsx))
hist2del_scale_up = TH2F("hist2del_scale_up","hist2del_scale_up", 7 ,array('d',binsx), 7, array('d',binsx))
hist2del_scale_dn = TH2F("hist2del_scale_dn","hist2del_scale_dn", 7 ,array('d',binsx), 7, array('d',binsx))
