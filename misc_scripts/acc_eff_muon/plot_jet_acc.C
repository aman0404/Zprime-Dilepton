{
//////Script for acceptance of jet plus acc. times efficiency of two muons in BB region/////
//
//
/////////////////////////////////////////////////////////////
...
//      TLatex *   tex = new TLatex(105,400,"CMS");
   ...
   TLatex *   tex2 = new TLatex(2700,0.95,"#mu#mu + jet Acc");
...
c1->SaveAs("plots/jet_acc_muon.png");
c1->SaveAs("plots/jet_acc_muon.pdf");
c1->SaveAs("plots/jet_acc_muon.root");
