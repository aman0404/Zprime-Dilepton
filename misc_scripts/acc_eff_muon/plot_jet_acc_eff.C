...
//////Script for acc. times eff. of vetoing b jet plus acc. times efficiency of two muons in BB region/////
//
//
/////////////////////////////////////////////////////////////
...
f1->GetObject("h_mu_acc_eff_0b", hdy);
...
f2->GetObject("h_mu_acc_eff_0b", hbbll[0]);
...
f3->GetObject("h_mu_acc_eff_0b", hbbll[1]);
...
f4->GetObject("h_mu_acc_eff_0b", hbbll[2]);
...
f5->GetObject("h_mu_acc_eff_0b", hbbll[3]);
...
//      TLatex *   tex = new TLatex(105,400,"CMS");
   ...
   TLatex *   tex2 = new TLatex(2700,0.95,"#mu#mu + jet Acc #times Eff, 0-bjet");
...
c1->SaveAs("plots/jet_acc_eff_0b_muon.png");
c1->SaveAs("plots/jet_acc_eff_0b_muon.pdf");
c1->SaveAs("plots/jet_acc_eff_0b_muon.root");
