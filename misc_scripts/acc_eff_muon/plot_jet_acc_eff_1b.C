{
//////Script for acc. times eff. of selecting 1 b jet plus acc. times efficiency of two muons in BB region/////
//
//
/////////////////////////////////////////////////////////////
...
//      TLatex *   tex = new TLatex(105,400,"CMS");
   ...
   TLatex *   tex2 = new TLatex(2700,0.45,"#mu#mu + jet Acc #times Eff, 1-bjet");
...
c1->SaveAs("plots/jet_acc_eff_1b_muon.png");
c1->SaveAs("plots/jet_acc_eff_1b_muon.pdf");
c1->SaveAs("plots/jet_acc_eff_1b_muon.root");
