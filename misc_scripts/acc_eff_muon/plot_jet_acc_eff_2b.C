{
//////Script for acc. times eff. of selecting 2 b jet plus acc. times efficiency of two muons in BB region/////
//
//
/////////////////////////////////////////////////////////////
...
f1->GetObject("h_mu_acc_eff_2b", hdy);
...
f2->GetObject("h_mu_acc_eff_2b", hbbll[0]);
...
f3->GetObject("h_mu_acc_eff_2b", hbbll[1]);
...
f4->GetObject("h_mu_acc_eff_2b", hbbll[2]);
...
f5->GetObject("h_mu_acc_eff_2b", hbbll[3]);
...
Double_t p[13] = {400, 500, 600, 700, 800, 900, 1000, 1100, 1200, 1300, 1400, 1500, 1600};

for(int i=0; i<=12; i++){
double err = 0;


Double_t A = hdy->IntegralAndError(hdy->GetXaxis()->FindBin(p[i]), hdy->GetXaxis()->FindBin(4000), err, ""); // "" or "width"
...
hdy->GetYaxis()->SetRangeUser(1e-5, 15);
//hdy->GetYaxis()->SetRangeUser(0, 0.4);
hdy->GetXaxis()->SetRangeUser(0, 4070);

        double y_legend = 16;
        //double y_legend = 0.41;
...
//      TLatex *   tex = new TLatex(105,400,"CMS");
   ...
   TLatex *   tex2 = new TLatex(2700,0.08,"#mu#mu + jet Acc #times Eff, >=2-bjet");
   //TLatex *   tex2 = new TLatex(2700,0.25,"#mu#mu + jet Acc #times Eff, >=2-bjet");
...
c1->SaveAs("plots/jet_acc_eff_2b_muon.png");
c1->SaveAs("plots/jet_acc_eff_2b_muon.pdf");
c1->SaveAs("plots/jet_acc_eff_2b_muon.root");
