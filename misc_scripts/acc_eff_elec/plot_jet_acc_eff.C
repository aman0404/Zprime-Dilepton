...
//      TLatex *   tex = new TLatex(105,400,"CMS");
   ...
   tex->SetLineWidth(2);
        tex->Draw();
        TLatex *   tex1 = new TLatex(x_legend+550,y_legend,"#it{#bf{Simulation}}");
   ...
   TLatex *   tex2 = new TLatex(2700,0.95,"ee + jet Acc #times Eff, 0-bjet");
...
c1->SaveAs("plots/jet_acc_eff_0b_elec.png");
c1->SaveAs("plots/jet_acc_eff_0b_elec.pdf");
c1->SaveAs("plots/jet_acc_eff_0b_elec.root");
