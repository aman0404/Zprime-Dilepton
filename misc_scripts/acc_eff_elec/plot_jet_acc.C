...
f2->GetObject("h_jet_acc", hbbll[0]);
...
f3->GetObject("h_jet_acc", hbbll[1]);
...
f4->GetObject("h_jet_acc", hbbll[2]);
...
f5->GetObject("h_jet_acc", hbbll[3]);
...
//      TLatex *   tex = new TLatex(105,400,"CMS");
   ...
   TLatex *   tex2 = new TLatex(2700,0.95,"ee + jet Acc");
...
c1->SaveAs("plots/jet_acc_elec.png");
c1->SaveAs("plots/jet_acc_elec.pdf");
c1->SaveAs("plots/jet_acc_elec.root");
