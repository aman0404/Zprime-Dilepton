...
hdy->GetXaxis()->SetTitle("M_{ee} [GeV]");
...
//      TLatex *   tex = new TLatex(105,400,"CMS");
   ...
   tex->SetLineWidth(2);
        tex->Draw();
        TLatex *   tex1 = new TLatex(x_legend+590,y_legend,"#it{#bf{Simulation}}");
   ...
   TLatex *   tex2 = new TLatex(2700,0.08,"ee + jet Acc #times Eff, >=2-bjet");
   //TLatex *   tex2 = new TLatex(2700,0.25,"ee + jet Acc #times Eff, >=2-bjet");
...
c1->SaveAs("plots/jet_acc_eff_2b_elec.png");
c1->SaveAs("plots/jet_acc_eff_2b_elec.pdf");
c1->SaveAs("plots/jet_acc_eff_2b_elec.root");
