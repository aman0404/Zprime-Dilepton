...
f1->GetObject("h_mu_acc_eff_1b", hdy);
...
f2->GetObject("h_mu_acc_eff_1b", hbbll[0]);
...
f3->GetObject("h_mu_acc_eff_1b", hbbll[1]);
...
f4->GetObject("h_mu_acc_eff_1b", hbbll[2]);
...
f5->GetObject("h_mu_acc_eff_1b", hbbll[3]);
...
hdy->GetYaxis()->SetRangeUser(1e-3, 15);
//hdy->GetYaxis()->SetRangeUser(0, 0.8);
hdy->GetXaxis()->SetRangeUser(0, 4070);

        double y_legend = 16;
        //double y_legend = 0.81;
        double x_legend = 300;
...
//      TLatex *   tex = new TLatex(105,400,"CMS");
   ...
   TLatex *   tex2 = new TLatex(2700,0.45,"ee + jet Acc #times Eff, 1-bjet");
...
c1->SaveAs("plots/jet_acc_eff_1b_elec.png");
c1->SaveAs("plots/jet_acc_eff_1b_elec.pdf");
c1->SaveAs("plots/jet_acc_eff_1b_elec.root");
