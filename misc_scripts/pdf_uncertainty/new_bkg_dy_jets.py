...
#paths = "/depot/cms/users/kaur214/output/test_npdf_weights_raw/stage1_output/2018/ttbar_lep_inclusive/*.parquet"
#paths = "/depot/cms/users/kaur214/output/test_npdf_weights_raw/stage1_output/2018/ttbar_lep_M*/*.parquet"
#paths = "/depot/cms/users/kaur214/output/test_npdf_weights_raw/stage1_output/2018/ttbar_lep*/*.parquet"
...
#df_dy   = df_dy[(df_dy["dimuon_mass_gen"] > 200.)]
df_dy   = df_dy[(df_dy["dimuon_mass"] > 200.)]

massBinningMuMu = [200, 300, 400,500,700,1100,1900,3500, 6000]
