...
TFile *f1 = TFile::Open("out_response_matrix_el_bb_script_1b_2b.root");
...
TFile *f22 = TFile::Open("../../../reco/ee/1b_bb_2018.root");
f22->GetObject("data_obs", hmu_data_unbin1);
...
TFile *f55 = TFile::Open("../../../reco/ee/1b_bb_2018.root");
...
TFile *file1 = new TFile("unfolded_mc_elec_bb_data_1b_2b.root","RECREATE");
file1->cd();
o->Write();
oMC->Write();
hmu_data_org->Write();
