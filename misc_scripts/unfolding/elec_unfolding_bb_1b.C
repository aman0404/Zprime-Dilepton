...
TFile *f1 = TFile::Open("out_response_matrix_el_bb_script_1b.root");
...
TFile *f5fake = TFile::Open("../../../reco/ee/fake_1b_bb_2018.root");
f5fake->GetObject("data_obs", hfake);
...
TFile *f5 = TFile::Open("../../reco/ee/1b_bb_2018.root");
...
TFile *file1 = new TFile("unfolded_mc_elec_bb_data_1b.root","RECREATE");
file1->cd();
o->Write();
oMC->Write();
hmu_data_org->Write();
