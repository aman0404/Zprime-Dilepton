...
void v4_sys_band_fratio_double_bb()
...
c1->SaveAs("plots/sys_band_fratio_double_total.png");
c1->SaveAs("plots/sys_band_fratio_double_total.pdf");
c1->SaveAs("plots/sys_band_fratio_double_total.root");
