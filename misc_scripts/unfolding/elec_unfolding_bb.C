...
TFile *f1 = TFile::Open("out_response_matrix_el_bb_script_0b.root");
...
TFile *f5fake = TFile::Open("../../../reco/ee/fake_0b_bb_2018.root");
...
TFile *f5 = TFile::Open("../../../reco/ee/0b_bb_2018.root");
...
TFile *file1 = new TFile("unfolded_mc_elec_bb_data.root","RECREATE");
file1->cd();
o->Write();
oMC->Write();
hmu_data_org->Write();
