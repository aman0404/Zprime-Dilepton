...
TFile *f1 = TFile::Open("out_response_matrix_mu_bb_script_1b.root");
...
TFile *f2 = TFile::Open("../../../reco/mumu/1b_bb_2018.root");
...
TFile *f4 = TFile::Open("../../../reco/mumu/1b_bb_2018.root");
f4->GetObject("DYJets", hmu_reco_unbin);

hmu_reco_unbin->Scale(1.10);
...
TFile *f5 = TFile::Open("../../../reco/mumu/1b_bb_2018.root");
...
TFile *file1 = new TFile("unfolded_mc_muon_bb_data_1b.root","RECREATE");
file1->cd();
o->Write();
oMC->Write();
hmu_data_org->Write();
