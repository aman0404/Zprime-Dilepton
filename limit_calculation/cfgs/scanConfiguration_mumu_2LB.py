...
#systematics = ["lumi",'res','massScale',"zPeak", "ttbarSF" ,"pdf","ID", "ISO", "HLT", "PU", "JEC", "JER", "reco","btagSF_bc","btagSF_light","btagSF_bc_corr","btagSF_light_corr", "l1prefiring", "jets", "ttbar_dnn", "ttbarUncert", "stats"]
...
interferencesBBLL = ["negRL"]
interferencess = ["negRL"]
interferences = ["negRL"]
...
massesExp = [[4,4,12,500,10,3000000]]
#massesExp = [[4,6,22,500,10,3000000]]
