...
def makeLimitPlot(output,obs,chan,printStats=False,obs2="",obs2Asympt="",ratioLabel=""):
...
#    	leg=TLegend(0.55,0.55,0.87,0.87,"","brNDC")   
	...
	if not obs2 == "" or not obs2Asympt == "":
    		...
    		ratioPad.DrawFrame(200,0.,5500,2, "; ; %s"%ratioLabel)
...
if __name__ == "__main__":
	...
	if not args.obs == "":
    	...
    	makeLimitPlot(outputfile,obs,config.leptons,args.stats,args.obs2,args.obs2Asympt,args.ratioLabel)
