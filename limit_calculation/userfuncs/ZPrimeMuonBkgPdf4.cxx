...
#include "ZPrimeMuonBkgPdf4.h" 
#include "RooAbsReal.h" 
#include "RooAbsCategory.h" 
#include <math.h> 
#include "TMath.h" 

ClassImp(ZPrimeMuonBkgPdf4) 

 ZPrimeMuonBkgPdf4::ZPrimeMuonBkgPdf4(const char *name, const char *title, 
                        RooAbsReal& _mass,
                        RooAbsReal& _bkg_a,
                        RooAbsReal& _bkg_b,
                        RooAbsReal& _bkg_c,
 ...
 ZPrimeMuonBkgPdf4::ZPrimeMuonBkgPdf4(const ZPrimeMuonBkgPdf4& other, const char* name) :  
 ...
 Double_t ZPrimeMuonBkgPdf4::evaluate() const 
 {
   double bkg_a2 = bkg_a + (bkg_b2-bkg_b)*bkg_thr*TMath::Log(bkg_thr);
   double bkg_e2 = bkg_e - (bkg_b2-bkg_b)*bkg_thr;

   if (mass <= bkg_thr) {
      return exp(bkg_a+(mass-bkg_thr)*bkg_b+(mass-bkg_thr)*(mass-bkg_thr)*bkg_c+(mass-bkg_thr)*(mass-bkg_thr)*(mass-bkg_thr)*bkg_d)*pow(mass,bkg_e)*(bkg_syst_a + bkg_syst_b*mass);
   }
   else {
      return exp(bkg_a2+(mass-bkg_thr)*bkg_b2+(mass-bkg_thr)*(mass-bkg_thr)*bkg_c2+(mass-bkg_thr)*(mass-bkg_thr)*(mass-bkg_thr)*bkg_d2)*pow(mass,bkg_e2)*(bkg_syst_a + bkg_syst_b*mass);
   }
 }
