...
#include "ZPrimeMuonBkgPdf3.h" 
#include "RooAbsReal.h" 
#include "RooAbsCategory.h" 
#include <math.h> 
#include "TMath.h" 

ClassImp(ZPrimeMuonBkgPdf3) 

 ZPrimeMuonBkgPdf3::ZPrimeMuonBkgPdf3(const char *name, const char *title, 
                        RooAbsReal& _mass,
                        RooAbsReal& _bkg_a,
                        RooAbsReal& _bkg_b,
                        RooAbsReal& _bkg_c,
 ...
 ZPrimeMuonBkgPdf3::ZPrimeMuonBkgPdf3(const ZPrimeMuonBkgPdf3& other, const char* name) :  
 ...
 Double_t ZPrimeMuonBkgPdf3::evaluate() const 
 { 
   // ENTER EXPRESSION IN TERMS OF VARIABLE ARGUMENTS HERE 
   if (mass <= 500){
   	return exp(bkg_a2+mass*bkg_b2+mass*mass*bkg_c2)*pow(mass,bkg_e2)*(bkg_syst_a + bkg_syst_b*mass)*(0.9803 - 0.0001068*mass + 1.142e-07*mass*mass - 2.013e-11*mass*mass*mass - 5.904e-15*mass*mass*mass*mass + 1.634e-18*mass*mass*mass*mass*mass); 
   }
   else{
   	return exp(bkg_a+mass*bkg_b+mass*mass*bkg_c+mass*mass*mass*bkg_d)*pow(mass,bkg_e)*(bkg_syst_a + bkg_syst_b*mass)*(0.9803 - 0.0001068*mass + 1.142e-07*mass*mass - 2.013e-11*mass*mass*mass - 5.904e-15*mass*mass*mass*mass + 1.634e-18*mass*mass*mass*mass*mass); 
   }
 } 
