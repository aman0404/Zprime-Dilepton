...
if __name__ == '__main__':
    ...
    df_dy_rest   = df_dy_rest[(df_dy_rest["r"]==f"{parameters['regions']}") & (df_dy_rest["dilepton_mass"] > 200.) & (df_dy_rest["dilepton_mass"] < 4000.) ]
    ...
    df_ttbar_rest   = df_ttbar_rest[(df_ttbar_rest["r"]==f"{parameters['regions']}") & (df_ttbar_rest["dilepton_mass"] > 500.) & (df_ttbar_rest["dilepton_mass"] < 4000.)]
    ...
    df_w_rest   = df_w_rest[(df_w_rest["r"]==f"{parameters['regions']}") & (df_w_rest["dilepton_mass"] > 200.) & (df_w_rest["dilepton_mass"] < 4000.)]
