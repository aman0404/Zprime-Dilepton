...
sig_path = "/depot/cms/private/users/kaur214/output/elec_channel_2018_jec/stage1_output/2018/bsll_lambda1TeV_M1000to2000*/*parquet"
...
plt.savefig("plots_2018/bbll_4TeV_POSLL_scores_M1000to2000_total_model.png")
plt.savefig("plots_2018/bbll_4TeV_POSLL_scores_M1000to2000_total_model.pdf")
plt.clf()
...
#           print("signal ", sum(bins_sig[0]))
    ...
    plt.yscale('log')
    plt.legend(loc='upper right')
    plt.savefig(f"plots_2018/bsll_4TeV_POSLL_0.2.png")
    plt.clf()
