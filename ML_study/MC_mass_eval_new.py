...
if (len(load_features)-9) < 16:
   input_size = (len(load_features)-9)
...
model = model.double()
model.load_state_dict(torch.load("model_year2018_new.ckpt"))
model.eval()
...
df_sig_plot = df_sig.drop(columns = ["e1_eta", "dielectron_mass_gen", "e1_pt","e2_eta","e2_phi","e2_pt", "met","bjet1_pt","bjet1_eta","bjet1_phi","lb_angle","nbjets","min_bl_mass", "bjet1_mb1_dR","bjet1_mb2_dR","wgt_nominal","dataset","wgt_nominal", "dataset"])

df_data_plot = df_data.drop(columns = ["e1_eta", "dielectron_mass_gen", "e1_pt","e2_eta","e2_phi","e2_pt", "met","bjet1_pt","bjet1_eta","bjet1_phi","lb_angle","nbjets","min_bl_mass", "bjet1_mb1_dR","bjet1_mb2_dR","wgt_nominal","dataset","wgt_nominal", "dataset"])


df_sig_model = df_sig.drop(columns = ["wgt_nominal", "dataset", "bjet1_mb1_dR", "bjet1_mb2_dR", "dielectron_mass_gen", "dielectron_mass", "e1_phi","e2_phi", "bjet1_phi"])

df_data_model = df_data.drop(columns = ["wgt_nominal", "dataset", "bjet1_mb1_dR", "bjet1_mb2_dR", "dielectron_mass_gen", "dielectron_mass", "e1_phi","e2_phi", "bjet1_phi"])
...
df_ttbar_plot = dff_ttbar.drop(columns = ["e1_eta" , "dielectron_mass_gen", "e1_pt","e2_eta","e2_phi","e2_pt", "met", "bjet1_pt","bjet1_eta","bjet1_phi","lb_angle","nbjets", "min_bl_mass", "bjet1_mb1_dR","bjet1_mb2_dR","wgt_nominal","dataset","wgt_nominal", "dataset"])

df_dy_plot = dff_dy.drop(columns = ["e1_eta" , "dielectron_mass_gen", "e1_pt","e2_eta","e2_phi","e2_pt", "met", "bjet1_pt","bjet1_eta","bjet1_phi","lb_angle","nbjets", "min_bl_mass", "bjet1_mb1_dR","bjet1_mb2_dR","wgt_nominal","dataset","wgt_nominal", "dataset"])

df_diboson_plot = dff_diboson.drop(columns = ["e1_eta", "dielectron_mass_gen", "e1_pt","e2_eta","e2_phi","e2_pt", "met", "bjet1_pt","bjet1_eta","bjet1_phi","lb_angle","nbjets" , "min_bl_mass", "bjet1_mb1_dR","bjet1_mb2_dR","wgt_nominal","dataset","wgt_nominal", "dataset"])


df_ttbar_model = dff_ttbar.drop(columns = ["wgt_nominal", "dataset",  "bjet1_mb1_dR", "bjet1_mb2_dR", "dielectron_mass_gen", "dielectron_mass", "e1_phi","e2_phi", "bjet1_phi"])

df_dy_model = dff_dy.drop(columns = ["wgt_nominal", "dataset", "bjet1_mb1_dR", "bjet1_mb2_dR", "dielectron_mass_gen", "dielectron_mass", "e1_phi","e2_phi", "bjet1_phi"])

df_diboson_model = dff_diboson.drop(columns = ["wgt_nominal", "dataset", "bjet1_mb1_dR", "bjet1_mb2_dR", "dielectron_mass_gen", "dielectron_mass", "e1_phi","e2_phi", "bjet1_phi"])
...
hdata = TH1F("data_mu", "data_mu", 11, array('d', binsx))
...
file2 = TFile("ML_mass_ttbar_data_elec_2018_1b_new.root","RECREATE")
file2.cd()
hdata.Write()
hsignal.Write()
hdy_reco.Write()
