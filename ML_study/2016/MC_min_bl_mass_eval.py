...
df_sig_plot = df_sig.drop(columns = ["e1_eta", "dielectron_mass_gen", "e1_pt","e2_eta","e2_phi","e2_pt",                                      "bjet1_pt","bjet1_eta","bjet1_phi","lb_angle","nbjets","met","dielectron_mass", "bjet1_mb1_dR","bjet1_mb2_dR","wgt_nominal","dataset","wgt_nominal", "dataset"])
...
df_ttbar_plot = dff_ttbar.drop(columns = ["e1_eta" , "dielectron_mass_gen", "e1_pt","e2_eta","e2_phi","e2_pt",                                      "bjet1_pt","bjet1_eta","bjet1_phi","lb_angle","nbjets","met","dielectron_mass", "bjet1_mb1_dR","bjet1_mb2_dR","wgt_nominal","dataset","wgt_nominal", "dataset"])

df_dy_plot = dff_dy.drop(columns = ["e1_eta" , "dielectron_mass_gen", "e1_pt","e2_eta","e2_phi","e2_pt",                                      "bjet1_pt","bjet1_eta","bjet1_phi","lb_angle","nbjets","met","dielectron_mass", "bjet1_mb1_dR","bjet1_mb2_dR","wgt_nominal","dataset","wgt_nominal", "dataset"])

df_diboson_plot = dff_diboson.drop(columns = ["e1_eta", "dielectron_mass_gen", "e1_pt","e2_eta","e2_phi","e2_pt",                                      "bjet1_pt","bjet1_eta","bjet1_phi","lb_angle","nbjets","met","dielectron_mass", "bjet1_mb1_dR","bjet1_mb2_dR","wgt_nominal","dataset","wgt_nominal", "dataset"])
...
hdy_reco = TH1F("dy_reco_mu", "dy_reco_mu", 100, 0, 600)
histbkg_top =  TH1F("bkg_top", "bkg_top", 100, 0, 600)
histbkg_diboson =  TH1F("bkg_diboson", "bkg_diboson", 100, 0, 600)
hsignal = TH1F("hsignal", "hsignal", 100, 0, 600)
...
file2 = TFile("ML_min_ml_mass_ttbar_data_muon_2018_bb_script_1b.root","RECREATE")
file2.cd()
hsignal.Write()
hdy_reco.Write()
histbkg_top.Write()
