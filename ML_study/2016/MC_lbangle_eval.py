...
#sig_path = "/depot/cms/private/users/kaur214/output/elec_channel_2016/stage1_output/2016/bsll_lambda*/*parquet"

data_path = "/depot/cms/private/users/kaur214/output/elec_channel_2016/stage1_output/2016*/data_*/*parquet"
...
#sig_path = "output/trainData_v1/2016/sig/bbll_4TeV_*_posLL/*parquet"
#bkg_path = "output/trainData_v1/2016/bkg/*/*parquet"
#data_path = "output/trainData_v1/2016/data/*/*parquet"
...
file2 = TFile("ML_lb_angle_ttbar_data_elec_2016_1b.root","RECREATE")
file2.cd()
hdata.Write()
hsignal.Write()
hdy_reco.Write()
