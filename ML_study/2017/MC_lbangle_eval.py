...
model = model.double()
model.load_state_dict(torch.load("model_year2017.ckpt"))
model.eval()

sig_path = "/depot/cms/private/users/kaur214/output/elec_channel_2017/stage1_output/2017/bsll_lambda1TeV_M500to1000*/*parquet"
#sig_path = "/depot/cms/private/users/kaur214/output/elec_channel_2017/stage1_output/2017/bsll_lambda*/*parquet"

data_path = "/depot/cms/private/users/kaur214/output/elec_channel_2017/stage1_output/2017/data_*/*parquet"

bkg_path = "/depot/cms/private/users/kaur214/output/elec_channel_2017/stage1_output/2017/ttbar_lep_*/*parquet"
bkg_path1 = "/depot/cms/private/users/kaur214/output/elec_channel_2017/stage1_output/2017/tW/*parquet"
bkg_path2 = "/depot/cms/private/users/kaur214/output/elec_channel_2017/stage1_output/2017/Wantitop/*parquet"
bkg_path3 = "/depot/cms/private/users/kaur214/output/elec_channel_2017/stage1_output/2017/dy0J*/*parquet"
bkg_path4 = "/depot/cms/private/users/kaur214/output/elec_channel_2017/stage1_output/2017/dy1J*/*parquet"
bkg_path5 = "/depot/cms/private/users/kaur214/output/elec_channel_2017/stage1_output/2017/dy2J*/*parquet"
bkg_path6 = "/depot/cms/private/users/kaur214/output/elec_channel_2017/stage1_output/2017/WW*/*parquet"
bkg_path7 = "/depot/cms/private/users/kaur214/output/elec_channel_2017/stage1_output/2017/WZ*/*parquet"
bkg_path8 = "/depot/cms/private/users/kaur214/output/elec_channel_2017/stage1_output/2017/ZZ*/*parquet"


#sig_path = "output/trainData_v1/2017/sig/bbll_4TeV_*_posLL/*parquet"
#bkg_path = "output/trainData_v1/2017/bkg/*/*parquet"
#data_path = "output/trainData_v1/2017/data/*/*parquet"
...
df_sig_plot = df_sig.drop(columns = ["e1_eta", "dielectron_mass_gen", "e1_pt","e2_eta","e2_phi","e2_pt", "dielectron_mass","bjet1_pt","bjet1_eta","bjet1_phi","met","nbjets","min_bl_mass", "bjet1_mb1_dR","bjet1_mb2_dR","wgt_nominal","dataset","wgt_nominal", "dataset"])

df_data_plot = df_data.drop(columns = ["e1_eta", "dielectron_mass_gen", "e1_pt","e2_eta","e2_phi","e2_pt", "dielectron_mass","bjet1_pt","bjet1_eta","bjet1_phi","met","nbjets","min_bl_mass", "bjet1_mb1_dR","bjet1_mb2_dR","wgt_nominal","dataset","wgt_nominal", "dataset"])
...
df_ttbar_plot = dff_ttbar.drop(columns = ["e1_eta" , "dielectron_mass_gen", "e1_pt","e2_eta","e2_phi","e2_pt", "dielectron_mass", "bjet1_pt","bjet1_eta","bjet1_phi","min_bl_mass","nbjets", "met", "bjet1_mb1_dR","bjet1_mb2_dR","wgt_nominal","dataset","wgt_nominal", "dataset"])

df_dy_plot = dff_dy.drop(columns = ["e1_eta" , "dielectron_mass_gen", "e1_pt","e2_eta","e2_phi","e2_pt", "dielectron_mass", "bjet1_pt","bjet1_eta","bjet1_phi","min_bl_mass","nbjets", "met", "bjet1_mb1_dR","bjet1_mb2_dR","wgt_nominal","dataset","wgt_nominal", "dataset"])

df_diboson_plot = dff_diboson.drop(columns = ["e1_eta", "dielectron_mass_gen", "e1_pt","e2_eta","e2_phi","e2_pt", "dielectron_mass", "bjet1_pt","bjet1_eta","bjet1_phi","min_bl_mass","nbjets" , "met", "bjet1_mb1_dR","bjet1_mb2_dR","wgt_nominal","dataset","wgt_nominal", "dataset"])
...
hdata = TH1F("data_mu", "data_mu", 40, 0, 3.2)
hdy_reco = TH1F("dy_reco_mu", "dy_reco_mu", 40, 0, 3.2)
histbkg_top =  TH1F("bkg_top", "bkg_top", 40, 0, 3.2)
histbkg_diboson =  TH1F("bkg_diboson", "bkg_diboson", 40, 0, 3.2)
hsignal = TH1F("hsignal", "hsignal", 40, 0, 3.2)
...
file2 = TFile("ML_lb_angle_ttbar_data_elec_2017_1b.root","RECREATE")
file2.cd()
hdata.Write()
hsignal.Write()
hdy_reco.Write()
