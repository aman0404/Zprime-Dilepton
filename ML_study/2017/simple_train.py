...
sig_path1 = "/depot/cms/private/users/kaur214/output/muchannel_2018_testingmuSF_iso/stage1_output/2017/bsll_lambda1TeV_M*/*parquet"


bkg_path = "/depot/cms/private/users/kaur214/output/muchannel_2018_testingmuSF_iso/stage1_output/2017/ttbar*/*parquet"
...
train_data.to_parquet("/home/kaur214/Zp_analysis/Zprime-Dilepton/output/trainData_v1/2017/train_data.parquet")
...
val_data.to_parquet("/home/kaur214/Zp_analysis/Zprime-Dilepton/output/trainData_v1/2017/val_data.parquet")
...
plt.xlabel("Epochs")
plt.ylabel("Loss")
plt.savefig("/depot/cms/users/kaur214/analysis_facility/ML_plots/loss_epochs_wgt_div_bbll_2017.png")
plt.clf()
...
plt.xlabel("Epochs")
plt.ylabel("Loss")
plt.savefig("/depot/cms/users/kaur214/analysis_facility/ML_plots/loss_epochs_div_bbll_2017.png")
plt.clf()


torch.save(model.state_dict(), 'model_year2017_div_bbll_vtest.ckpt')
