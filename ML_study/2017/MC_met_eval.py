...
df_sig_plot = df_sig.drop(columns = ["e1_eta", "dielectron_mass_gen", "e1_pt","e2_eta","e2_phi","e2_pt", "dielectron_mass","bjet1_pt","bjet1_eta","bjet1_phi","lb_angle","nbjets","min_bl_mass", "bjet1_mb1_dR","bjet1_mb2_dR","wgt_nominal","dataset","wgt_nominal", "dataset"])

df_data_plot = df_data.drop(columns = ["e1_eta", "dielectron_mass_gen", "e1_pt","e2_eta","e2_phi","e2_pt", "dielectron_mass","bjet1_pt","bjet1_eta","bjet1_phi","lb_angle","nbjets","min_bl_mass", "bjet1_mb1_dR","bjet1_mb2_dR","wgt_nominal","dataset","wgt_nominal", "dataset"])
...
df_ttbar_plot = dff_ttbar.drop(columns = ["e1_eta" , "dielectron_mass_gen", "e1_pt","e2_eta","e2_phi","e2_pt", "dielectron_mass", "bjet1_pt","bjet1_eta","bjet1_phi","lb_angle","nbjets", "min_bl_mass", "bjet1_mb1_dR","bjet1_mb2_dR","wgt_nominal","dataset","wgt_nominal", "dataset"])

df_dy_plot = dff_dy.drop(columns = ["e1_eta" , "dielectron_mass_gen", "e1_pt","e2_eta","e2_phi","e2_pt", "dielectron_mass", "bjet1_pt","bjet1_eta","bjet1_phi","lb_angle","nbjets", "min_bl_mass", "bjet1_mb1_dR","bjet1_mb2_dR","wgt_nominal","dataset","wgt_nominal", "dataset"])

df_diboson_plot = dff_diboson.drop(columns = ["e1_eta", "dielectron_mass_gen", "e1_pt","e2_eta","e2_phi","e2_pt", "dielectron_mass", "bjet1_pt","bjet1_eta","bjet1_phi","lb_angle","nbjets" , "min_bl_mass", "bjet1_mb1_dR","bjet1_mb2_dR","wgt_nominal","dataset","wgt_nominal", "dataset"])
...
file2 = TFile("ML_met_ttbar_data_elec_2017_1b.root","RECREATE")
file2.cd()
hdata.Write()
hsignal.Write()
hdy_reco.Write()
