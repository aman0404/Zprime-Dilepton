...
plt.savefig("plots_2017/bsll_scores_M500to1000_total_model.png")
plt.savefig("plots_2017/bsll_scores_M500to1000_total_model.pdf")
plt.clf()
...
#       print(bkg_value)
    ...
    plt.yscale('log')
    plt.legend(loc='upper right')
    plt.savefig(f"plots_2017/bsll_4TeV_POSLL_0.2.png")
    plt.clf()
